...
ax1.plot(J, n.rates(J, gain=1, bias=-3),label="gain=1, bias=-3") 
ax1.plot(J, n.rates(J, gain=1, bias=-4),label="gain=1, bias=-4") 
ax1.plot(J, n.rates(J, gain=2, bias=-3),label="gain=2, bias=-3") 
ax1.plot(J, n.rates(J, gain=2, bias=-4),label="gain=2, bias=-4") 
