...
drugs_effect={'control':0.00,'PHE':-0.2,'GFC':0.4} #for additive_noise, [gfc_mean, phe_mean];
ramp_scale=0.42 #how fast does the 'time' dimension accumulate in WM neurons
BG_delta_ramp=-0.6 #change in ramp value from baseline when using BG decision procedure
...
record_spike_fraction=0.05 #number of neurons in WM to add to dataframe and plot
